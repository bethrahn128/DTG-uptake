---
title: "IeDEA SA256 DTG uptake: 03 Paper Fig 2 by ctry, sex & age"
subtitle: " "
...
```{r}
sjPlot::tab_xtab(tblBAS_1$sex_age2_txt,
                 tblBAS_1$dtg_first_txt,
                 show.row.prc = TRUE, show.summary = FALSE)
```
...
by country and sex & age, by calendar year (aggregated quarterly).
...
dtg1 <- tblBAS %>% 
  ...
  group_by(ctry, country, sex_age2_txt, qtr, recart_d_qtr, recommend_d_qtr,dtg_recomend_d, recommend_date,  min_dtg_date) %>%
  summarise(
    numer = sum(dtg_first),
    denom = n()) %>%
  mutate(line = "dtg") %>%
...
data$sex_age2_txt <- factor(data$sex_age2_txt, levels = c("Male 20-49", "Male 50+", "Female 20-49", "Female 50+"),
...
plotA_all <- ggplot(data_temp, aes(x=recart_d_qtr, y=value, color=sex_age2_txt)) + 
 geom_line(stat="identity", size= 0.7, linetype = 1, show.legend = TRUE) +
...
#ggsave("output/Paper/DTG_initiation_by_ctry_sexage_quarterly.png", width = 7, height =8)  
...
plotA_LSO <- ggplot(data_temp2, aes(x=recart_d_qtr, y=value, color=sex_age2_txt)) + 
 geom_line(stat="identity", size= 0.7, linetype = 1, show.legend = TRUE) +
  scale_fill_manual(labels = ~ stringr::str_wrap(.x, width = 40), values = fill)  +
  scale_color_manual(labels = ~ stringr::str_wrap(.x, width = 40), values = fill) +
   theme_bw() + 
...
plotA_MWI <- ggplot(data_temp2, aes(x=recart_d_qtr, y=value, color=sex_age2_txt)) + 
 geom_line(stat="identity", size= 0.7, linetype = 1, show.legend = TRUE) +
  scale_fill_manual(labels = ~ stringr::str_wrap(.x, width = 40), values = fill)  +
  scale_color_manual(labels = ~ stringr::str_wrap(.x, width = 40), values = fill) +
   theme_bw() + 
...
plotA_MOZ <- ggplot(data_temp2, aes(x=recart_d_qtr, y=value, color=sex_age2_txt)) + 
 geom_line(stat="identity", size= 0.7, linetype = 1, show.legend = TRUE) +
  scale_fill_manual(labels = ~ stringr::str_wrap(.x, width = 40), values = fill)  +
  scale_color_manual(labels = ~ stringr::str_wrap(.x, width = 40), values = fill) +
   theme_bw() + 
  theme(plot.title = element_text(size = 12, hjust = 0.5, vjust =0),
       ...
       #legend.box.background = element_rect(color = "black"),
        ...
        strip.background = element_blank(),
        strip.text.x = element_text(size=12),
        axis.title.y = element_text(margin = margin(t = 1, r = 1, b = 1, l = 1),size=11),
...
plotA_ZAF <- ggplot(data_temp2, aes(x=recart_d_qtr, y=value, color=sex_age2_txt)) + 
 geom_line(stat="identity", size= 0.7, linetype = 1, show.legend = TRUE) +
  scale_fill_manual(labels = ~ stringr::str_wrap(.x, width = 40), values = fill)  +
  scale_color_manual(labels = ~ stringr::str_wrap(.x, width = 40), values = fill) +
   theme_bw() + 
...
plotA_ZMB <- ggplot(data_temp2, aes(x=recart_d_qtr, y=value, color=sex_age2_txt)) + 
 geom_line(stat="identity", size= 0.7, linetype = 1, show.legend = TRUE) +
  scale_fill_manual(labels = ~ stringr::str_wrap(.x, width = 40), values = fill)  +
  scale_color_manual(labels = ~ stringr::str_wrap(.x, width = 40), values = fill) +
   theme_bw() + 
...
# create final file
data_temp2 <- rbind(data_temp, extra)
plotA_ZWE <- ggplot(data_temp2, aes(x=recart_d_qtr, y=value, color=sex_age2_txt)) + 
 geom_line(stat="identity", size= 0.7, linetype = 1, show.legend = TRUE) +
  scale_fill_manual(labels = ~ stringr::str_wrap(.x, width = 40), values = fill)  +
  scale_color_manual(labels = ~ stringr::str_wrap(.x, width = 40), values = fill) +
   theme_bw() + 
...
plotA_row1 <- (plotA_LSO + theme(plot.margin = unit(c(0,0,0,0), "pt"))) + (plotA_MWI + theme(plot.margin = unit(c(0,0,0,0), "pt")))
plotA_row1


plotA_row2 <- (plotA_MOZ + theme(plot.margin = unit(c(0,0,0,0), "pt"))) + (plotA_ZAF + theme(plot.margin = unit(c(0,0,0,0), "pt")))
plotA_row2

plotA_row3 <- (plotA_ZMB + theme(plot.margin = unit(c(0,0,0,0), "pt"))) + (plotA_ZWE + theme(plot.margin = unit(c(0,0,0,0), "pt")))
plotA_row3


plotA_v1 <- plot_spacer() / plotA_row1 / plot_spacer() / plotA_row2 / plot_spacer() / plotA_row3 + plot_layout(heights = c(-1.3, 8.5, -1.6, 8.6, -1.2, 8.6), guides = "collect") & theme(legend.position = "bottom", legend.justification = "left")
plotA_v1

plotA_v1 <-  plotA_row1 / plot_spacer() / plotA_row2 / plot_spacer() / plotA_row3 + plot_layout(heights = c(8.5, -1.6, 8.6, -1.2, 8.6), guides = "collect") & theme(legend.text = element_blank (), legend.position = "none", legend.justification = "left")
plotA_v1
...
plotA_v2 <-  plotA_row1 / plot_spacer() / plotA_row2 / plot_spacer() / plotA_row3 + plot_layout(heights = c(8.5, -1.6, 8.6, -1.2, 8.6), guides = "collect") +  plot_annotation(title = '(A) Initiating dolutegravir', 
                  caption = '',
...
ggsave("output/Paper/DTG_initiation_ctry_sexage2_calendar_v2_Quarter.png", width = 6, height =8)
...
FU_time$sex_age2_txt <- factor(FU_time$sex_age2_txt, levels = c("Male 20-49", "Male 50+", "Female 20-49", "Female 50+"),
                       labels = c( "Men 20-49", "Men 50+", "Women 20-49", "Women 50+"))
...
## Cumulative incidence of DTG switch: Overall
    ...
    y = "",
        title = "Cumulative incidence of DTG switch in Southern Africa"
         ...
         theme(axis.title = element_text(size = 14),
          plot.title = element_text(size = 12, hjust = 0.5, vjust =0), #center title
...
## Cumulative incidence of DTG switch: by sex & age

```{r}

FU_time_temp <- FU_time 

bysex <- survfit2(Surv(time_t2, dtg_switch_txt_crr2b.factor) ~ sex_age2_txt, data = FU_time_temp) %>%
       ggcuminc(outcome = c("Switch to dolutegravir", "Competing risks"), 
           linetype_aes = FALSE, 
           theme = theme_ggsurvfit_default(), 
           size = 1) +
...
## B) Cumulative incidence of DTG switch: By country by sex & age
...
fit_LSO <- survfit2(Surv(time_t2, dtg_comp_b) ~ sex_age2_txt, data = FU_time_temp, etype = dtg_switch_txt_crr2b.factor)
...
plotB_LSO <- survfit2(Surv(time_t2, dtg_switch_txt_crr2b.factor) ~ sex_age2_txt, data = FU_time_temp) %>%
       ggcuminc(outcome = c("Switch to dolutegravir", "Competing risks"), 
           linetype_aes = FALSE, 
           theme = theme_ggsurvfit_default(), 
           size = 0.7) +
...
plotB_MWI <- survfit2(Surv(time_t2, dtg_switch_txt_crr2b.factor) ~ sex_age2_txt, data = FU_time_temp) %>%
   ggcuminc(outcome = c("Switch to dolutegravir", "Competing risks"), 
           linetype_aes = FALSE, 
           theme = theme_ggsurvfit_default(), 
           size = 0.7) +
...
plotB_MOZ <- survfit2(Surv(time_t2, dtg_switch_txt_crr2b.factor) ~ sex_age2_txt, data = FU_time_temp) %>%
   ggcuminc(outcome = c("Switch to dolutegravir", "Competing risks"), 
           linetype_aes = FALSE, 
           theme = theme_ggsurvfit_default(), 
           size = 0.7) +
...
plotB_ZAF <- survfit2(Surv(time_t2, dtg_switch_txt_crr2b.factor) ~ sex_age2_txt, data = FU_time_temp) %>%
    ggcuminc(outcome = c("Switch to dolutegravir", "Competing risks"), 
           linetype_aes = FALSE, 
           theme = theme_ggsurvfit_default(), 
           size = 0.7) +
...
plotB_ZMB <- survfit2(Surv(time_t2, dtg_switch_txt_crr2b.factor) ~ sex_age2_txt, data = FU_time_temp) %>%
   ggcuminc(outcome = c("Switch to dolutegravir", "Competing risks"), 
           linetype_aes = FALSE, 
           theme = theme_ggsurvfit_default(), 
           size = 0.7) +
...
plotB_ZWE <- survfit2(Surv(time_t2, dtg_switch_txt_crr2b.factor) ~ sex_age2_txt, data = FU_time_temp) %>%
  ggcuminc(outcome = c("Switch to dolutegravir", "Competing risks"), 
           linetype_aes = FALSE, 
           theme = theme_ggsurvfit_default(), 
           size = 0.7) +
...
plotB_row1 <- (plotB_LSO + theme(plot.margin = unit(c(0,0,0,0), "pt"))) + (plotB_MWI + theme(plot.margin = unit(c(0,0,0,0), "pt")))
plotB_row1


plotB_row2 <- (plotB_MOZ + theme(plot.margin = unit(c(0,0,0,0), "pt"))) + (plotB_ZAF + theme(plot.margin = unit(c(0,0,0,0), "pt")))
plotB_row2

plotB_row3 <- (plotB_ZMB + theme(plot.margin = unit(c(0,0,0,0), "pt"))) + (plotB_ZWE + theme(plot.margin = unit(c(0,0,0,0), "pt")))
plotB_row3


#plotB_v1 <- plotB_row1 / plot_spacer() / plotB_row2 / plot_spacer() / plotB_row3 + plot_layout(heights = c(8.5, -1.6, 8.6, -1.2, 8.6), guides = "collect") & theme(legend.position = "bottom", legend.justification = "left")
#plotB_v1


plotB_v1 <- plotB_row1 / plotB_row2 /  plotB_row3 + plot_layout(heights = c(8.5,  8.5,  8.5), guides = "collect") & theme(legend.position = "bottom", legend.justification = "left")
plotB_v1
...
plotB_v2 <- plotB_row1 / plot_spacer() / plotB_row2 / plot_spacer() / plotB_row3 + plot_layout(heights = c(8.5, -1.6, 8.6, -1.2, 8.6), guides = "collect") +  plot_annotation(title = '(B) Switching to dolutegravir', 
                  caption = '',
...
ggsave("output/Paper/DTG_transition_CR_ctry_sexage2_calendar_v2_quarter.png", width = 6, height =8)
...
FU_time_temp <- FU_time %>% filter(country =="ZMB" & (age_cat3 == "[20,30)" | age_cat3 =="[30,40)")) %>% mutate(dtg_comp_b = ifelse(dtg_switch_txt_crr2b.factor == "Competing risks", 1, 0))

frq(FU_time_temp, dtg_comp_b)
frq(FU_time_temp, dtg_status_outcome_txt)
frq(FU_time_temp, dtg_switch_txt_crr2b.factor)

#fit1_dtg0_ctry <- survfit2(Surv(time_t2, dtg_comp_b) ~ ctry, data = FU_time_1_noDTG, etype = dtg_first_txt_crr1b.factor)
test <- survfit2(Surv(time_t2, dtg_comp_b) ~ sex, data = FU_time_temp, etype = dtg_switch_txt_crr2b.factor)
  
  
  ggcuminc(test, outcome = c("Switch to dolutegravir","Competing risks"), 
           linetype_aes = FALSE, 
           theme = theme_ggsurvfit_default(), 
           size = 1.5) +
    ylim(c(0, 1)) 
...
plotA_v1 <- plotA_row1 / plotA_row2 / plotA_row3 + plot_layout(heights = c(8.5, 8.5, 8.5), guides = "collect") & theme(legend.position = "bottom", legend.justification = "left")
plotA_v1
...
## Combine plots: initation and switching (patchwork v1)
...
Fig1 <- 
  ...
  (plotA_LSO + plotA_MWI + plot_spacer() + plotB_LSO + plotB_MWI + plot_layout(nrow = 1, width =c(6,6,-0.5,6,6), height =c(6,6,6,6,6))) /
  
  (plotA_MOZ + plotA_ZAF + plot_spacer() + plotB_MOZ + plotB_ZAF + plot_layout(nrow = 1, width =c(6,6,-0.5,6,6), height =c(6,6,6,6,6))) /
  
  (plotA_ZMB + plotA_ZWE + plot_spacer() + plotB_ZMB + plotB_ZWE + plot_layout(nrow = 1, width =c(6,6,-0.5,6,6), height =c(6,6,6,6,6))) +
  
  
  plot_layout(guides = "collect") + plot_annotation(title = '(A) Initiating dolutegravir                        (B) Switching to dolutegravir', 
                  caption = '',
theme=theme(plot.title=element_text(hjust=0.5, size = 16))) & theme(legend.position = "bottom", legend.justification = "center")
...
ggsave("output/Paper/Fig2_CompeteRisks_ctry_sexage2_quarter_v1.png", width = 8.5, height =8.5)
...
Fig1 <- 
  ...
  (plotA_LSO + plotA_MWI + plot_spacer() + plotB_LSO + plotB_MWI + plot_layout(ncol = 5, widths= c(5.2, 5.2, 1, 5.2, 5.2))) / 
  
  
  (plotA_MOZ + plotA_ZAF + plot_spacer() + plotB_MOZ + plotB_ZAF + plot_layout(ncol = 5, widths= c(5.2, 5.2, 1, 5.2, 5.2))) / 
  
  
  (plotA_ZMB + plotA_ZWE + plot_spacer() + plotB_ZMB + plotB_ZWE + plot_layout(ncol = 5, widths= c(5.2, 5.2, 1, 5.2, 5.2))) /  
  
  plot_layout(guides = "collect") + 
  plot_annotation(title = '(A) Initiating dolutegravir                          (B) Switching to dolutegravir', 
                  caption = '',
theme=theme(plot.title=element_text(hjust=0.5, size = 15))) & theme(legend.position = "bottom", legend.justification = "center")

Fig1
  
  

ggsave("output/Paper/Fig2_CompeteRisks_ctry_sexage2_quarter_v2.png", width = 8.5, height =8.5)
...
Fig1 <- 
  ...
  plotA_LSO + plotA_MWI + plot_spacer() + plotB_LSO + plotB_MWI +
  
  plotA_MOZ + plotA_ZAF + plot_spacer() + plotB_MOZ + plotB_ZAF +
  
  plotA_ZMB + plotA_ZWE + plot_spacer() + plotB_ZMB + plotB_ZWE + 
  
  
  plot_layout(ncol = 5, widths=c(3,3,0.5,3,3), heights =c(8,8,8), guides = "collect") +
  
  plot_annotation(title = '(A) Initiating dolutegravir                          (B) Switching to dolutegravir', 
                  caption = '',
                  
theme=theme(plot.title=element_text(hjust=0.5, size = 15))) & theme(legend.position = "bottom", legend.justification = "center", legend.text = element_text(size =11)) 

Fig1
  
  

ggsave("output/Paper/Fig2_CompeteRisks_ctry_sexage2_quarter_v3.png", width = 8.5, height =8.5)
```
...
sf <- survfit2(Surv(time_t2, dtg_switch) ~ ctry, data = FU_time)
...
ggsave("output/Paper/Fig2_Switch_KM_plot_country.png", width = 7, height =4)
...
sf2 <- survfit2(Surv(time_t2, dtg_switch) ~ country + sex_age2_txt , data = FU_time_temp)
...
## "Survival" by country at end-2022
...
## "Survival" by country & sex at end-2022
