---
title: "SA256 DTG uptake <br> Switching cohort"
subtitle: " "
author: ""
date: "`r Sys.Date()`"
output:
...
### 2. **Ensure all patients have >=15 months of potential follow-up since national DTG adoption date**
...
### 3. Ensure all programs have patients starting ART >=24m after national DTG adoption date

Programs without patients starting ART >= 24m after national DTG adoption

```{r}
exclude = data.table(read_fst("data_temp/tblBAS_cohort1_progexclude_ART24m_v010.fst"))
...
```{r}
write_fst(tblBAS, "data_temp/tblBAS_cohort2_LTFU_WHO_v011.fst")
```

```{r eval=FALSE, include=FALSE}
test <- tblBAS %>% filter(country =="ZMB" & (age_cat3 == "[20,30)" | age_cat3 =="[30,40)")) %>% select(patient, country, rev_outcome, rev_outcome_d, max_close_d)
```
...
ggsave("output/Cohort_transition/Descriptive/DTG_switch_by_country.png", width = 8, height =4)
...
ggplot(data, aes(x=program, y=percentage, fill=outcome, label = text2)) + 
  ...
  geom_text(size = 4.5, colour = "white", fontface = "bold", position = position_stack(reverse = TRUE, vjust = 0.8))
# Print plot to a png file
ggsave("output/Cohort_transition/Descriptive/DTG_switch_by_program.png", width = 8, height =4)
...
ggsave("output/Cohort_transition/Descriptive/DTG_switch_by_country_sex.png", width = 7, height =6)
...
ggsave("output/Cohort_transition/Descriptive/DTG_switch_by_sex_age.png", width = 7, height =6)
...
ggsave("output/Cohort_transition/Descriptive/DTG_switch_proportion_by_country_sex.png", width = 7, height =5)
...
ggsave("output/Cohort_transition/Descriptive/DTG_switch_proportion_by_agegroup_sex.png", width = 7, height =4)
...
#ggsave("output/figures/SA256_KM_DTG_survfit_cohort1_sex.png", width = 7, height =4)
...
#ggsave("output/figures/SA256_KM_DTG_survfit_cohort1_age3.png", width = 7, height =4)
...
ggsave("output/Cohort_transition/KM/DTG_switch_KM_DTG_survfit_sex_age.png", width = 7, height =4)
...
ggsave("output/Cohort_transition/KM/SA256_KM_DTG_survfit_Ctry.png", width = 7, height =4)
...
ggsave("output/Cohort_transition/KM/SA256_KM_DTG_survfit_Prog.png", width = 7, height =4)
...
#ggsave("output/Cohort_transition/KM/SA256_KM_DTG_survfit_Sexage.png", width = 7, height =4)
...
#ggsave("output/figures/SA256_KM_DTG_survfit_Sexage.png", width = 7, height =4)
...
ggsave("output/Cohort_transition/KM/Survplot_DTG_switch_ctry_sex_time.png", width = 5.5, height =8.5)
...
ggsave("output/Cohort_transition/KM/Survplot_DTG_switch_ctry_age_time.png", width = 5.5, height =8.5)
...
ggsave("output/Cohort_transition/KM/Survplot_DTG_switch_ctry_sexage_time.png", width = 5.5, height =8.5)
...
ggsave("output/Cohort_transition/KM/Survplot_DTG_switch_ctry_sex_calendar.png", width = 7, height =5)
...
#ggsave("output/figures/SA256_KM_DTG_survfit_date_age_cat3_facet_cohort2_ctry.png", width = 9, height =6)
...
#ggsave("output/figures/SA256_KM_DTG_survfit_date_sexage_facet_cohort2_ctry.png", width = 12, height =6)
...
#ggsave("output/Cohort_transition/Competing_risks/Survplot_DTG_switch_ctry_sex_calendar.png", width = 5.5, height =8.5)
...
ggsave("output/Cohort_transition/Competing_risks/combine_DTG_Cumul_incid_DTG_switch_ctry_sex_calendar.png", width = 7, height =8)
```
...
ggsave("output/Cohort_transition/Competing_risks/combine_DTG_Cumul_incid_DTG_switch_ctry_sex20-50_calendar.png", width = 7, height =8)
```
...
ggsave("output/Cohort_transition/Competing_risks/combine_DTG_Cumul_incid_DTG_switch_ctry_sex20-40_calendar.png", width = 7, height =8)
```
...
ggsave("output/Cohort_transition/Competing_risks/combine_DTG_Cumul_incid_DTG_switch_ctry_sexage_calendar.png", width = 7, height =8)
```
...
ggsave("output/Cohort_transition/Competing_risks/combine_DTG_Cumul_incid_DTG_switch_ctry_sex_time.png", width = 7, height =8)
```
...
ggsave("output/Cohort_transition/Competing_risks/combine_DTG_Cumul_incid_DTG_switch_ctry_sexage_time.png", width = 7, height =8)
```
...
ggsave("output/Cohort_transition/Competing_risks/Cumul_incid_all_outcomes.png", width = 7, height =6)
...
ggsave("output/Cohort_transition/Competing_risks/Cumul_incid_all_outcomes_sex.png", width = 7, height =6)
...
ggsave("output/Cohort_transition/Competing_risks/Cumul_incid_all_outcomes_ctry.png", width = 7, height =5.5)
...
ggsave("output/Cohort_transition/Competing_risks/Cumul_incid_all_outcomes_ctry_sex.png", width = 7, height =9.5)
...
ggsave("output/Cohort_transition/Competing_risks/Cumul_incid_onegroup.png", width = 7, height =5)
...
ggsave("output/Cohort_transition/Competing_risks/Cumul_incid_sex.png", width = 7, height =5)
...
ggsave("output/Cohort_transition/Competing_risks/Cumul_incid_sex_age.png", width = 7, height =5)
...
ggsave("output/Cohort_transition/Competing_risks/Cumul_incid_ctry.png", width = 7, height =5)
...
ggsave("output/Cohort_transition/Competing_risks/Cumul_incid_ctry_sex.png", width = 7.5, height =10)
...
ggsave("output/Cohort_transition/Outcomes/DTGswitch_Cumul_incid_all_outcomes.png", width = 7, height =6)
...
ggsave("output/Cohort_transition/Outcomes/DTGswitch_sex_Cumul_incid_all_outcomes.png", width = 7, height =6)
...
ggsave("output/Cohort_transition/Outcomes/DTGswitch_ctry_Cumul_incid_all_outcomes.png", width = 7, height =6)
...
ggsave("output/Cohort_transition/Outcomes/DTGswitch_ctry_sex_Cumul_incid_all_outcomes.png", width = 7, height =9.5)
...
ggsave("output/Cohort_transition/Outcomes/noDTGswitch_Cumul_incid_all_outcomes.png", width = 7, height =6)
...
ggsave("output/Cohort_transition/Outcomes/combine_DTG_Cumul_incid_all_outcomes.png", width = 9, height =6)
...
ggsave("output/Cohort_transition/Outcomes/noDTGswitch_sex_Cumul_incid_all_outcomes.png", width = 7, height =6)
...
ggsave("output/Cohort_transition/Outcomes/noDTGswitch_ctry_Cumul_incid_all_outcomes.png", width = 7, height =6)
...
ggsave("output/Cohort_transition/Outcomes/noDTGswitch_ctry_sex_Cumul_incid_all_outcomes.png", width = 7, height =9.5)
...
#ggsave("output/figures/SA256_KM_DTG_compete.png", width = 8, height =4)
...
#ggsave("output/figures/SA256_KM_DTG_sex.png", width = 8, height =4)

#ggsave(file = "output/figures/ggsurv_v1.png", print(survp))
...
#ggsave("output/figures/SA256_KM_DTG_sex_v2.png", width = 8, height =4)

#ggsave("output/figures/survival_v2.png", plot = p, 
...
#ggsave("output/figures/SA256_KM_DTG_ctry.png", width = 8, height =4)
...
#ggsave("output/figures/SA256_KM_DTG_ctry_v2.png", width = 8, height =10)
...
#ggsave("output/figures/SA256_KM_DTG_prog.png", width = 8, height =4)
...
#ggsave("output/figures/SA256_KM_DTG_prog_v2.png", width = 8, height =10)
...
#ggsave("output/figures/SA256_KM_DTG_sex_age2.png", width = 8, height =4)
...
#ggsave("output/figures/SA256_KM_DTG_sex_age2_v2.png", width = 8, height =10)
